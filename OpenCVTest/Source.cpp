...
int main(int argc, char *argv[]) {
	...
	begin = clock();
	Mat src = imread("..//imgs//barcodes//1_rotate.bmp", CV_LOAD_IMAGE_COLOR);
	if (!src.data) {
	...
	Mat after_threshold;
	threshold(after_blur, after_threshold, 200, 255, 0);
	...
	//vector<Vec4i> lines;
	//HoughLinesP(after_threshold, lines, 1, CV_PI / 180, 50, 30, 10);
